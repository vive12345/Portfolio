...
const CONFIG = {
    ...
    custom: {
      ...
      projects: [
        ...
        },
        {
          ...
          achievements: ['40% latency reduction across productivity dashboards'],
        },
        {
          ...
          category: 'academic/personal',
          achievements: ['Maintained <1.6 ms latency during high-speed telemetry playback'],
        },
        {
          ...
          techStack: ['Python', 'PLY', 'SWI-Prolog', 'Lexical Analysis', 'Parsing'],
          domain: 'Programming Languages',
          githubUrl: 'https://github.com/vive12345/Poodle-The-Programming-Language-',
          youtubeUrl: 'https://youtu.be/odOh4-f9qrM',
          category: 'academic/personal',
          achievements: ['Delivered a full compiler implementation with REPL support'],
        },
        {
          name: 'ScrumSim',
          about:
          ...
          achievements: ['85% automated test coverage across simulator workflows'],
        },
        {
          ...
          category: 'academic/personal',
          achievements: ['ML-powered recommendations improved adherence for pilot users'],
        },
        {
          ...
          category: 'academic/personal',
          achievements: ['92% accuracy identifying high-risk students in validation cohorts'],
        },
        {
          ...
          techStack: ['Flask', 'Python', 'OpenRouteService', 'KMeans', 'Folium'],
          domain: 'Field Operations AI',
          category: 'industrial',
          companyUrl: 'https://repzone.com/aboutus?culture=en',
          achievements: ['Cut manual route planning from hours to minutes while balancing workload across offices'],
        },
      ],
    },
    github: {
  ...
  experiences: [
    ...
    },
    {
      ...
      description: [
        'Worked in a team of 3 engineers for a company\'s internal portal (details confidential) to turn store knowledge bases into embeddings so their LLM assistant could draft outreach emails and answer marketing questions directly from the data. Built a object detection demo for one of the client\'s urgent needs.',
        'Devised a high-performance RESTful API for AI model interaction, optimizing data flow and improving data retrieval times.',
        'Developed a microservice module to retrieve and match employee records with live inputs, reducing manual verification.',
        'Optimized a Python script workaround to fix object detection errors, securing client confidence during a key demo.'
      ],
    },
    {
      company: 'EzTechStack',
  ...
  certifications: [
    {
      ...
      year: 'Oct 2025',
      body:
        'I learned how to design and tune Oracle AI Vector Search, build vector indexes, and serve semantic search workloads that keep latency predictable for AI assistants.',
    ...
    },
    {
      ...
      year: 'Oct 2025',
      body:
        'I mastered OCI AI foundations—standing up data lakes, wiring model endpoints, and choosing the right managed services so teams can ship responsible AI safely.',
    ...
    },
    {
      ...
      year: 'Oct 2025',
      body:
        'I deepened my generative AI skills by fine-tuning foundation models on OCI, managing guardrails, and delivering compliant AI copilots for enterprise workflows.',
      image: 'src/assets/Images/genai.png',
    },
  ],
  publications: [
